 ...
 * ================================================
 */
public final class AppGlutinousRice implements GlutinousRiceModule {

    @Override
    public void applyOptions(Context context, GlutinousRiceBuilder.Builder builder) {
...
//               .imageLoaderStrategy(new CustomLoaderStrategy())
                ...
                //以下代码只是配置, 还要使用 Okhttp (AppComponent中提供) 请求服务器获取到正确的 BaseUrl 后赋值给 AppGlutinousRice.sDomain
...
//                    okhttpBuilder.sslSocketFactory(); //支持 Https,详情请百度
    ...
    @Override
    public void expandFragment(Context context, List<FragmentManager.FragmentLifecycleCallbacks> lifecycles) {
