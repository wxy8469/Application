...
import static com.dawncos.cmodule.base.android.AppManager.APP_EXIT;
import static com.dawncos.cmodule.base.android.AppManager.KILL_ALL;
import static com.dawncos.cmodule.base.android.AppManager.SHOW_SNACKBAR;
import static com.dawncos.cmodule.base.android.AppManager.START_ACTIVITY;

/**  一些框架常用的工具  */
public class CModuleUtils {
    static public Toast mToast;


    private CModuleUtils() {
    ...
    public static AppComponent obtainAppComponentFromContext(Context context) {
        ...
        Preconditions.checkState(context.getApplicationContext() instanceof IApplication, "Application does not implements IApplication");
