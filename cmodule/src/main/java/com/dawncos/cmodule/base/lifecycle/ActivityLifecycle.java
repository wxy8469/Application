...
import com.dawncos.cmodule.base.android.BaseFragment;
import com.dawncos.cmodule.base.android.IConfig;
import com.dawncos.cmodule.base.delegate.ActivityDelegate;
import com.dawncos.cmodule.base.delegate.ActivityDelegateImp;
import com.dawncos.cmodule.base.delegate.FragmentDelegate;
...
public class ActivityLifecycle implements Application.ActivityLifecycleCallbacks {
    ...
    private void registerFragmentCallbacks(Activity activity) {
        ...
        if (activity instanceof FragmentActivity && useFragment) {
            ...
            if (mExtras.containsKey(IntelligentCache.KEY_KEEP + IConfig.class.getName())) {
                List<IConfig> modules = (List<IConfig>) mExtras.get(IntelligentCache.KEY_KEEP + IConfig.class.getName());
                for (IConfig module : modules) {
                    module.injectFragmentLifecycle(mApplication, mFragmentLifecycles.get());
                }
                mExtras.remove(IntelligentCache.KEY_KEEP + IConfig.class.getName());
            }
