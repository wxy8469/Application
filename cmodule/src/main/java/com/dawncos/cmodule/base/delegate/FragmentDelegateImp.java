...
public class FragmentDelegateImp implements FragmentDelegate {
    ...
    public FragmentDelegateImp(@NonNull android.support.v4.app.FragmentManager fragmentManager, @NonNull android.support.v4.app.Fragment fragment) {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        iFragment.setupFragmentComponent(CModuleUtils.obtainAppComponentFromContext(mFragment.getActivity()));
    }
