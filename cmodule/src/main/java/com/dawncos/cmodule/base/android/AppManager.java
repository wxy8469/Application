...
public final class AppManager {
     ...
     * 建议在 {@link IConfig#injectAppLifecycle(Context, List)} 中
     * 通过 {@link AppDelegate#onCreate(Application)} 在 IApplication 初始化时,使用此方法传入自定义的 {@link HandleListener}
     *
...
//        }
     ...
     * 退出应用程序
     * <p>
     * 此方法经测试在某些机型上并不能完全杀死 IApplication 进程, 几乎试过市面上大部分杀死进程的方式, 但都发现没卵用, 所以此
