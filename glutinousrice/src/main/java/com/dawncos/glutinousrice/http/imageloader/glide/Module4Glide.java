...
import com.dawncos.glutinousrice.http.OkHttpUrlLoader;
...
/**
 * -----------------------------------------------
 * {@link AppGlideModule} 默认实现类
 * Created by wxy8469
 * <a href="mailto:wxy8469163@gmail.com">Contact me</a>
 * <a href="https://github.com/wxy8469/Application">Follow me</a>
 * -----------------------------------------------
 */
@GlideModule(glideName = "ModuleGlide")
public class Module4Glide extends AppGlideModule {
    public static final int IMAGE_DISK_CACHE_MAX_SIZE = 100 * 1024 * 1024;//图片缓存文件最大值为100Mb

    @Override
    public void applyOptions(Context context, GlideBuilder builder) {
        AppComponent AppComponent = ModuleUtil.getAppComponent(context);
