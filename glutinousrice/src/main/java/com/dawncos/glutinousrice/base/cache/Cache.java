package com.dawncos.glutinousrice.base.cache;
...
/**
 * -----------------------------------------------
 * 用于缓存框架中所必需的组件,开发者可通过 {@link GlutinousRiceBuilder.Builder#cacheFactory(Factory)}
 * 为框架提供缓存策略开发者也可以用于自己日常中的使用
 * @see GlutinousRiceBuilder#provideCacheFactory(Application)
 * @see LruCache
 * Created by wxy8469
