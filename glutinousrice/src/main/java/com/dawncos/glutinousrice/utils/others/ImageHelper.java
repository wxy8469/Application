package com.dawncos.glutinousrice.utils.others;
...
public class ImageHelper {
    ...
    public static Drawable getScaleDrawableForRadioButton(float percent, TextView tv) {
        ...
        return getScaleDrawableWithPercent(percent, drawable);
    }
    ...
    public static Drawable getScaleDrawableForRadioButton2(float width, TextView tv) {
        ...
        return getScaleDrawableWithWidth(width, drawable);
    }
     ...
     * @return
     */
    public static Drawable getScaleDrawableWithPercent(float percent, Drawable drawable) {
     ...
     * @return
     */
    public static Drawable getScaleDrawableWithWidth(float width, Drawable drawable) {
    ...
    public static Bitmap doBlur(Bitmap sentBitmap, int radius, boolean canReuseInBitmap) {
     ...
     public static void blur(Context context, Bitmap bkg, View view) {
         ...
         float scaleFactor = 8;
         //放大到整个view的大小
         bkg = ImageHelper.getReSizeBitmap(bkg, view.getMeasuredWidth(), view.getMeasuredHeight());
     ...
     public static Bitmap blurBitmap(Bitmap bkg, int width, int height) {
         ...
         float scaleFactor = 8;
         //放大到整个view的大小
         bkg = ImageHelper.getReSizeBitmap(bkg, width, height);
