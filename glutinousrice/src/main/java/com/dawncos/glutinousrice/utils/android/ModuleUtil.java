...
import static com.dawncos.glutinousrice.utils.android.ActivityHelper.APP_EXIT;
import static com.dawncos.glutinousrice.utils.android.ActivityHelper.KILL_ALLACTIVITY;
import static com.dawncos.glutinousrice.utils.android.ActivityHelper.SHOW_SNACKBAR;
import static com.dawncos.glutinousrice.utils.android.ActivityHelper.START_ACTIVITY;
...
public class ModuleUtil {
    ...
    public static void snackbarText(String text) {
        ...
        message.obj = text;
        message.arg1 = 0;
        ActivityHelper.postEventBus(message);
    }
    ...
    /**
     * 跳转界面 1 ,通过 {@link ActivityHelper#startActivity(Class)}
     *
     * @param activityClass
     */
    ...
    /**
     * 跳转界面 2 ,通过 {@link ActivityHelper#startActivity(Intent)}
     *
     * @param
     */
    ...
    /**
     * 远程遥控 {@link ActivityHelper#killAllActivity()}
     */
    public static void killAll() {
        Message message = new Message();
        message.what = KILL_ALLACTIVITY;
        ActivityHelper.postEventBus(message);
    }

    /**
     * 远程遥控 {@link ActivityHelper#appExit()}
     */
    ...
    public static AppComponent getAppComponent(Context context) {
        Preconditions.checkNotNull(context, "%s cannot be null",
                Context.class.getName());
        Timber.d(context.toString() + " getAppComponent");
        Preconditions.checkState(context.getApplicationContext() instanceof IAppLifecycle,
                "Application does not implements IApplication");
        return ((IAppLifecycle) context.getApplicationContext()).getAppComponent();
    }
