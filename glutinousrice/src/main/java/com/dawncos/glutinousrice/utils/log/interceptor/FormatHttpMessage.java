 ...
 * -----------------------------------------------
 */
public class FormatHttpMessage implements FormatHttpMsg {
    private static final String TAG = "DCM_Http_Log";
    ...
    public void printJsonResponse(long chainMs, boolean isSuccessful, int code, String headers, MediaType contentType,
        ...
        bodyString = HttpLogInterceptor.isJson(contentType) ? CharacterHelper.jsonFormat(bodyString)
                : HttpLogInterceptor.isXml(contentType) ? CharacterHelper.xmlFormat(bodyString) : bodyString;
